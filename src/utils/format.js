export const fmt = (n) =>
  new Intl.NumberFormat('zh-TW', { style: 'currency', currency: 'TWD', minimumFractionDigits: 0, maximumFractionDigits: 4 }).format(n)

/** 小數點後第 4 位，無條件進位（用於 C食材/D包材單價） */
export const fmtPrice = (n) => {
  const rounded = Math.ceil((parseFloat(n) || 0) * 10000) / 10000
